...
const EnrollSection = () => {
  ...
  <h1 className='capitalize font-semibold text-lg'>enroll to this course</h1>
    <p className='text-xs'>Choose from over 210,000 online video courses with new additions published every month</p>
    <Button className='bg-green-900 text-orange-500 hover:bg-orange-500 hover:text-green-900'>Enroll Now</Button>
